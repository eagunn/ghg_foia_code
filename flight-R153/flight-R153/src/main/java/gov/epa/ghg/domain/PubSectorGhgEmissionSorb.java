...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_SORB")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionSorb implements Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionSorb() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionSorb(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission, String fuelType) {
		this.id = id;
