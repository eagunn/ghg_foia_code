...
public class BarViewController {
    ...
    @RequestMapping(value = "/barSector/{ds}/{year}/{stateAbbr}", method = RequestMethod.GET)
    public @ResponseBody
    JSONObject barSector(
        ...
        if (StringUtils.hasLength(ds) && ("O".equals(ds) || sectors.isOnshorePetroleumSectorOnly() || "B".equals(ds) || sectors.isBoostingSectorOnly())) {
            return barChartService.barChartBasin(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), basin,
                    gases, sectors, qo, rs);
        }
        else if(StringUtils.hasLength(ds) && "A".equals(ds)) {
        	return barChartService.barRR(q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),state,countyFips!=null?String.valueOf(countyFips):"",
                    msaCode!=null?String.valueOf(msaCode):"",gases, sectors, qo, ds, rs, emissionsType, tribalLandId);
		}
        else {
            if (trend == null || !trend.equals("trend")) {
                return barChartService.barChartSector(q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),state,countyFips!=null?String.valueOf(countyFips):"",
                        msaCode!=null?String.valueOf(msaCode):"",gases, sectors, qo, ds, rs, emissionsType, tribalLandId);
            }
            else {
                return barChartService.barChartSectorTrend(q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),state,countyFips!=null?String.valueOf(countyFips):"",
                        gases, sectors, qo,rs);
            }
        }
    }
    ...
    @RequestMapping(value = "/barSectorL2/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barSectorL2(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        return barChartService.barChartSectorL2(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, ds, rs, emissionsType, tribalLandId);
    }

    @RequestMapping(value = "/barGas/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barGas(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return barChartService.barChartGas(q, year, stateCode, fipsCode != null ? String.valueOf(fipsCode) : "", lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE),
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, rs);
    }

    @RequestMapping(value = "/barState/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barState(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        return barChartService.barChartState(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, rs, emissionsType, tribalLandId);
    }

    @RequestMapping(value = "/barStateL2/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barStateL2(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return barChartService.barChartStateL2(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, rs, emissionsType, tribalLandId);
    }

    @RequestMapping(value = "/barStateL22/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barStateL22(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return barChartService.barChartStateL3(null,q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),state,countyFips!=null?String.valueOf(countyFips):"",
                msaCode!=null?String.valueOf(msaCode):"", gases, sectors, qo,rs, emissionsType, null);
    }

    @RequestMapping(value = "/barStateL3/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barStateL3(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return barChartService.barChartStateL3(ss, q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, rs, emissionsType, tribalLandId);
    }

    @RequestMapping(value = "/barSupplier/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject barSupplier(
        ...
        QueryOptions qo = new QueryOptions(searchOptions);
        return barChartService.barChartSupplier(q, qo, year, sc, rs, st);
    }
