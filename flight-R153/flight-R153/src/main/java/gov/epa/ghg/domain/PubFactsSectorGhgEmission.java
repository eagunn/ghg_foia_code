...
public class PubFactsSectorGhgEmission implements java.io.Serializable {
	 ...
	 * default constructor
	 */
	public PubFactsSectorGhgEmission() {
	}
	
	/**
	 * full constructor
	 */
	public PubFactsSectorGhgEmission(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission) {
		this.id = id;
