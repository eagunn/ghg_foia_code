...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_PET")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionPet implements Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionPet() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionPet(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission, String fuelType) {
		this.id = id;
