...
@Table(name = "PUB_FACTS_SECTOR_GHG_EMISSION")
public class FacilityAllSectorEmission implements java.io.Serializable {
	
	private static final long serialVersionUID = 1L;
	
	// Fields
	private PubFactsSectorGhgEmissionId id;
	private FacilityAll facility;
	 ...
	 * default constructor
	 */
	public FacilityAllSectorEmission() {
	}
	
	/**
	 * full constructor
	 */
	public FacilityAllSectorEmission(PubFactsSectorGhgEmissionId id, FacilityAll facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission) {
		this.id = id;
	...
	public FacilityAll getFacility() {
		return this.facility;
	}
	
	public void setFacility(FacilityAll facility) {
		this.facility = facility;
	}
