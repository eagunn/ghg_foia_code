...
@Table(name = "PUB_DIM_FACILITY_PIPE_MV")
public class DimFacilityPipe implements java.io.Serializable {
	...
	private Set<PubFactsSectorPipe> emPipe = new HashSet<PubFactsSectorPipe>(0);
	private Set<DimFacilityStatus> facStatus = new HashSet<DimFacilityStatus>(0);
	private Set<PubStatePipe> geos = new HashSet<PubStatePipe>(0);
	 ...
	 * default constructor
	 */
	public DimFacilityPipe() {
	}
	
	/**
	 * full constructor
	 */
	public DimFacilityPipe(DimFacilityId id, Double latitude, Double longitude, String city,
			...
			byte[] rrMonitoringPlan, String rrFilename, String rrLink) {
		this.id = id;
	...
	public Set<PubFactsSectorPipe> getEmPipe() {
		return emPipe;
	}
	
	public void setEmPipe(Set<PubFactsSectorPipe> emPipe) {
		this.emPipe = emPipe;
	}
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "facility")
	public Set<PubStatePipe> getGeos() {
		return geos;
	}
	
	public void setGeos(Set<PubStatePipe> geos) {
		this.geos = geos;
	}
