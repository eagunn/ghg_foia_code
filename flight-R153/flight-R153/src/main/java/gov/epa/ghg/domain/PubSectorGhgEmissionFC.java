...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_FC")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionFC implements Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionFC() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionFC(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission) {
		this.id = id;
