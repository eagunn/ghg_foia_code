...
/**
 * PubDimFacility entity. @author MyEclipse Persistence Tools
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Table(name = "PUB_DIM_FACILITY")
//@Indexed
//@Analyzer(impl=org.apache.lucene.analysis.standard.StandardAnalyzer.class)
public class DimFacility implements java.io.Serializable {
	...
	private Set<PubSf6Territory> territories = new HashSet<PubSf6Territory>(0);
	 ...
	 * full constructor
	 */
	public DimFacility(DimFacilityId id, Double latitude, Double longitude, String city,
	...
	public String retrieveBasinCode() {
		String retv = "";
		if (basins != null && basins.size() != 0) {
			for (PubBasinFacility basin : basins) {
				retv = basin.getLayer().getBasinCode();
			}
		}
		return retv;
	}
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "facility")
	public Set<PubSf6Territory> getTerritories() {
		return territories;
	}
	
	public void setTerritories(Set<PubSf6Territory> territories) {
