...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_OTHER")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionOther implements Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionOther() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionOther(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission, String fuelType) {
		this.id = id;
