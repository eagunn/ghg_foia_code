...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_UC")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionUC implements java.io.Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionUC() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionUC(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission) {
		this.id = id;
