...
@Table(name = "PUB_FACTS_SECTOR_PIPE_EMISSION")
public class PubFactsSectorPipe implements java.io.Serializable {
	
	private static final long serialVersionUID = 1L;
	
	// Fields
	private PubFactsSectorPipeId id;
	 ...
	 * default constructor
	 */
	public PubFactsSectorPipe() {
	}
	
	/**
	 * full constructor
	 */
	public PubFactsSectorPipe(PubFactsSectorPipeId id, DimFacilityPipe facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission, String state) {
		this.id = id;
	...
	public PubFactsSectorPipeId getId() {
		return this.id;
	}
	
	public void setId(PubFactsSectorPipeId id) {
		this.id = id;
	}
