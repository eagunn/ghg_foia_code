...
import gov.epa.ghg.service.TreeChartService;
...
public class TreeViewController {
        ...
        @Inject
        TreeChartService treeChartService;

    @RequestMapping(value = "/treeSector/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody
    JSONObject treeSector(
        ...
        if (StringUtils.hasLength(ds) && ("O".equals(ds) || sectors.isOnshorePetroleumSectorOnly() || "B".equals(ds) || sectors.isBoostingSectorOnly())) {
            return treeChartService.treeChartBasin(q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),basin,
                    gases, sectors, qo,rs);
        } else {
            return treeChartService.treeChartSector(q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),state,countyFips!=null?String.valueOf(countyFips):"",
                    msaCode!=null?String.valueOf(msaCode):"",gases, sectors, qo, ds, rs, emissionsType);
        }
    }

    @RequestMapping(value = "/treeSectorL2/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeSectorL2(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartSectorL2(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, ds, rs, emissionsType);
    }

    @RequestMapping(value = "/treeSectorL3/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeSectorL3(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartSectorL3(ss, q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, ds, rs, emissionsType);
    }

    @RequestMapping(value = "/treeSectorL4/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeSectorL4(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartSectorL4(ss, q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, ds, rs, emissionsType);
    }

    @RequestMapping(value = "/treeGas/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeGas(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartGas(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                msaCode != null ? String.valueOf(msaCode) : "", gases, sectors, qo, rs);
    }

    @RequestMapping(value = "/treeState/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeState(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartState(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                gases, sectors, qo, rs);
    }

    @RequestMapping(value = "/treeStateL2/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeStateL2(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartStateL2(q, year, lowE != null ? String.valueOf(lowE) : "", String.valueOf(highE), state, countyFips != null ? String.valueOf(countyFips) : "",
                gases, sectors, qo, rs);
    }

    @RequestMapping(value = "/treeStateL3/{ds}/{year}", method = RequestMethod.GET)
    public @ResponseBody JSONObject treeStateL3(
            @PathVariable(value="ds") String ds,
            @PathVariable(value="year") int year,
            @RequestParam(value="q", required=false) String q,
            @RequestParam(value="st", required=false) String state,
        ...
        SectorFilter sectors = new SectorFilter(s1, s2, s3, s4, s5, s6, s7, s8, s9,
                ...
                s901, s902, s903, s904, s905, s906, s907, s908, s909, s910, s911);
        QueryOptions qo = new QueryOptions(searchOptions);
        return treeChartService.treeChartStateL3(q,year,lowE!=null?String.valueOf(lowE):"",String.valueOf(highE),state,countyFips!=null?String.valueOf(countyFips):"",
                gases, sectors, qo,rs);
    }

        @RequestMapping(value = "/treeSupplier/{year}", method = RequestMethod.GET)
        public @ResponseBody JSONObject treeSupplier(
                ...
                QueryOptions qo = new QueryOptions(searchOptions);
                return treeChartService.treeChartSupplier(q, qo, year, sc, rs, st);
        }
