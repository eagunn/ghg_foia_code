...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_NG")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionNg implements Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionNg() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionNg(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission, String fuelType) {
		this.id = id;
