...
@Entity
@Table(name = "PUB_SECTOR_GHG_EMISSION_PE")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class PubSectorGhgEmissionPE implements java.io.Serializable {
	 ...
	 * default constructor
	 */
	public PubSectorGhgEmissionPE() {
	}
	
	/**
	 * full constructor
	 */
	public PubSectorGhgEmissionPE(PubFactsSectorGhgEmissionId id, DimFacility facility, DimSector sector, DimGhg gas, DimSubSector subSector, BigDecimal co2eEmission) {
		this.id = id;
