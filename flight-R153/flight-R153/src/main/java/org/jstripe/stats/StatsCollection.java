...
public class StatsCollection implements InitializingBean, DisposableBean, ApplicationContextAware {
    ...
    public void serialize() throws IOException {
        ...
        try {
            ...
            log.error("Could not write stats data to "+makeFile().getAbsolutePath(), e);
        } finally {
            log.info("stats serialized in "+(System.currentTimeMillis() - t)+"ms.");
        }
    }
    ...
    private Map deserialize(File f) {
        ...
        if (f.exists() && f.canRead()) {
            ...
            try {
                ...
                log.info("stats data read in "+(System.currentTimeMillis() - t)+"ms.");
            } catch (Throwable e) {
                log.error("Could not read stats data from "+f.getAbsolutePath(), e);
            }
        }
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (stats != null) {
            ...
            log.info("Stats data file not found. Empty file assumed.");
        }
